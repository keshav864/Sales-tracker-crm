...
const getDefaultUsers = (): User[] => [
  ...
  // Team Members under Salim Javed (DGM) - Bihar/Delhi & West Bengal/Odisha
  // Bihar Team
  {
    id: 'BM222',
    employeeId: 'BM222',
  ...
  // West Bengal, Odisha Team under Salim Javed
  {
    id: 'BM241',
    employeeId: 'BM241',
    name: 'Sajib Bose',
  ...
  // Team Members under Sandeep Bediawala (Gujarat) - Gujarat & Chhattisgarh
  {
    id: 'BM234',
    employeeId: 'BM234',
    name: 'Zameer Khan',
  ...
  // Team Members under Pawan Khanna & Dhiraj Prakash (Sales Managers) - MP & Rajasthan
  {
    id: 'BM252',
    employeeId: 'BM252',
