...
const getDefaultUsers = (): User[] => [
  ...
  },
  {
    ...
    territory: 'West Bengal',
    isActive: true,
    lastLogin: new Date(Date.now() - 11 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: 'BM261',
    employeeId: 'BM261',
  ...
  },
  {
    ...
    territory: 'West Bengal',
    isActive: true,
    lastLogin: new Date(Date.now() - 13 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: 'BM263',
    employeeId: 'BM263',
  ...
  },
  {
    ...
    territory: 'Nagpur',
    isActive: true,
    lastLogin: new Date(Date.now() - 17 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: 'BM265',
    employeeId: 'BM265',
  ...
  },
  {
    ...
    territory: 'Jabalpur',
    isActive: true,
    lastLogin: new Date(Date.now() - 19 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: 'BM267',
    employeeId: 'BM267',
    ...
    territory: 'Gujarat',
    isActive: true,
    lastLogin: new Date(Date.now() - 20 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: 'BM268',
    employeeId: 'BM268',
    ...
    territory: 'Surat',
    isActive: true,
    lastLogin: new Date(Date.now() - 21 * 60 * 60 * 1000).toISOString(),
  },

  // Team Members under Pawan Khanna (Sales Manager) - MP & Rajasthan (4 members)
  {
    id: 'BM252',
    employeeId: 'BM252',
    ...
    territory: 'Rajasthan',
    isActive: true,
    lastLogin: new Date(Date.now() - 22 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: 'BM235',
    employeeId: 'BM235',
    ...
    isActive: true,
    lastLogin: new Date(Date.now() - 23 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: 'BM269',
    employeeId: 'BM269',
  ...
  },
  {
    ...
    territory: 'Jaipur',
    isActive: true,
    lastLogin: new Date(Date.now() - 25 * 60 * 60 * 1000).toISOString(),
  },

  // Team Members under Dhiraj Prakash (Sales Manager) - MP & Rajasthan (4 members)
  {
    id: 'BM254',
    employeeId: 'BM254',
    name: 'Nitin Jaiswal',
  ...
  },
  {
    ...
    territory: 'Bhopal',
    isActive: true,
    lastLogin: new Date(Date.now() - 27 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: 'BM273',
    employeeId: 'BM273',
    ...
    territory: 'Gwalior',
    isActive: true,
    lastLogin: new Date(Date.now() - 28 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: 'BM274',
    employeeId: 'BM274',
    ...
    territory: 'Ujjain',
    isActive: true,
    lastLogin: new Date(Date.now() - 29 * 60 * 60 * 1000).toISOString(),
  },
  ...
  },
  {
    ...
    territory: 'Gujarat',
    isActive: true,
    lastLogin: new Date(Date.now() - 31 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: 'BM276',
    employeeId: 'BM276',
    ...
    territory: 'Rajasthan',
    isActive: true,
    lastLogin: new Date(Date.now() - 32 * 60 * 60 * 1000).toISOString(),
  },
];
